...
export const useFeedPageStyles = styled(theme => ({
    container: {
        display: "grid",
        // gridAutoFlow: "column",
...
export const useExploreSuggestionsStyles = styled(theme => ({
    container: {
        width: 935
    },
    typography: {
...
export const useExploreGridStyles = styled(theme => ({
    article: {
        display: "grid",
...
export const useLoginPageStyles = styled({
    signUpCard: {
        maxWidth: 348,
        padding: "16px 40px",
        marginBottom: 10,
...
export const useSignUpPageStyles = styled({
...
export const useNavbarStyles = styled(theme => ({
    appBar: {
...
export const RedTooltip = styled({
    popper: {
...
export const useLayoutStyles = styled(theme => ({
    section: {
        display: "flex",
        flexDirection: "column",
        flexGrow: 1,
...
export const usePostModalStyles = styled(theme => ({
    overlay: {
...
export const useFollowButtonStyles = styled({
    button: {
...
export const useFeedPostStyles = styled(theme => ({
    article: {
...
export const usePostStyles = styled(theme => ({
    moreIcon: {
        height: 24,
        width: 18,
        justifySelf: "center",
...
export const useLoadingScreenStyles = styled({
    section: {
        height: "100%",
        position: "absolute",
        width: "100%",
...
export const useUserCardStyles = styled({
    avatar: {
...
export const useFollowSuggestionsStyles = styled(theme => ({
    container: {
        maxWidth: "100vw"
    },
    slide: {
...
export const useFeedSideSuggestionsStyles = styled(theme => ({
    article: {
        margin: "12px 0",
        gridTemplateColumns: "minmax(auto, 600px)",
        justifyContent: "center"
...
export const useOptionsDialogStyles = styled(theme => ({
    dialogScrollPaper: {
...
export const useProfilePictureStyles = styled({
    person: {
        color: "#ffffff",
...
export const useEditProfilePageStyles = styled(theme => ({
    section: {
        display: "grid",
        gridAutoFlow: "column",
        [theme.breakpoints.down("sm")]: {
...
export const useFeedPostSkeletonStyles = styled({
    container: {
        display: "flex",
        flexDirection: "column",
        overflow: "hidden",
...
export const usePostSkeletonStyles = styled(theme => ({
    container: {
        overflow: "hidden",
        position: "relative",
        borderRadius: "3px",
...
export const useNotificationListStyles = styled(theme => ({
    listContainer: {
...
export const useProfilePageStyles = styled(theme => {
...
export const useProfileTabsStyles = styled(theme => {
...
export const useGridPostStyles = styled(theme => ({
    image: {
        width: "100%",
        userSelect: "none"
    },
...
export const useMorePostsFromUserStyles = styled(theme => ({
    article: {
        display: "grid",
        gridTemplateColumns: "minmax(auto, 935px)",
        width: "100vw"
